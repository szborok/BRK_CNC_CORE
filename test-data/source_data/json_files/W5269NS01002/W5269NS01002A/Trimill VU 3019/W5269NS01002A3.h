...
12;
13; --- TOOLLIST BEGIN ---------------
14; T2117953779 | WID-TCF-TF53_H100W50L130X / DM=53 CR=0 TL=392.8
15; ---- TOOLLIST END ----------------
16;
17 ; --- BLOCK FORM -------------------
...
34 ; ----------------------------------
35 * - TOOL: T2117953779 | WID-TCF-TF53_H100W50L130X / DM=53 CR=0 TL=392.8
36 TOOL CALL "TF53000002630360" Z S781 DL+0 DR+0
...
67 CYCL DEF 200 DRILLING~
 ...
 Q202=97 ;PLUNGING DEPTH~
 Q210=0 ;DWELL TIME AT TOP~
 Q203=1 ;SURFACE COORDINATE~
 Q204=29 ;2ND SET-UP CLEARANCE~
 Q211=0 ;DWELL TIME AT BOTTOM
68 L X454 Y-304 R0 F MAX M99
69 L X454 Y304 R0 F MAX M99
70 L X-454 Y304 R0 F MAX M99
71 L X-454 Y-304 R0 F MAX M99
72 ; ----------------------------------
