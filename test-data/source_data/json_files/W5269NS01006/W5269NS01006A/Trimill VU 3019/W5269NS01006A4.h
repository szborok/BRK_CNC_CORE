...
12;
13; --- TOOLLIST BEGIN ---------------
14; T880358013 | TGT-TOP5-TF17.5_H100W25L100X / DM=17.5 CR=0 TL=210.9
15; ---- TOOLLIST END ----------------
16;
17 ; --- BLOCK FORM -------------------
...
34 ; ----------------------------------
35 * - TOOL: T880358013 | TGT-TOP5-TF17.5_H100W25L100X / DM=17.5 CR=0 TL=210.9
36 TOOL CALL "TF17500001110359" Z S1819 DL+0 DR+0
...
67 CYCL DEF 200 DRILLING~
 ...
 Q202=86.382 ;PLUNGING DEPTH~
 Q210=0 ;DWELL TIME AT TOP~
 Q203=1 ;SURFACE COORDINATE~
 Q204=29 ;2ND SET-UP CLEARANCE~
 Q211=0 ;DWELL TIME AT BOTTOM
68 L X395 Y-268 R0 F MAX M99
69 L X395 Y268 R0 F MAX M99
70 L X-395 Y268 R0 F MAX M99
71 L X-395 Y-268 R0 F MAX M99
72 ; ----------------------------------
